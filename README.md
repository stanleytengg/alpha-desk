...
本工作區是 [PatrickSUDO/fadacai-portfolio](https://github.com/PatrickSUDO/fadacai-portfolio)（MIT, Copyright © 2026 fadacai）的衍生作品，已大幅客製：移除券商整合與組合管理、改為 watchlist-driven、推送改 Discord、新增加密貨幣研究。原始 MIT 著作權聲明保留於 `LICENSE`。
